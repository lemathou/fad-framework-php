...
if ($class_name == "mail")
{
	include PATH_INCLUDE."/mail.inc.php";
}
elseif ($class_name == "img")
{
	include PATH_INCLUDE."/image.inc.php";
}
elseif ($class_name == "text")
{
	include PATH_INCLUDE."/text.inc.php";
}
elseif (substr($class_name, -7) == "agregat" && ($name=substr($class_name, 0, -8)) && datamodel()->exists_name($name))
{
	datamodel()->{$name};
}
